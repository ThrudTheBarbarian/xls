proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins axixl_0/s_axi]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/ACLK] [get_bd_pins axixl_0/s_axi_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/ARESETN] [get_bd_pins axixl_0/s_axi_ARESETN]
...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI ] [get_bd_intf_pins axixl_0/m_axi]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/ACLK] [get_bd_pins axixl_0/m_axi_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/ARESETN] [get_bd_pins axixl_0/m_axi_ARESETN]
	connect_bd_net -net init_axi_txn_00 [get_bd_ports m_axi_INIT_AXI_TXN] [get_bd_pins axixl_0/m_axi_INIT_AXI_TXN]
	connect_bd_net -net error_00 [get_bd_ports m_axi_ERROR] [get_bd_pins axixl_0/m_axi_ERROR]
	connect_bd_net -net txn_done_00 [get_bd_ports m_axi_TXN_DONE] [get_bd_pins axixl_0/m_axi_TXN_DONE]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/axixl_v1_0_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef axixl_v1_0_tb_include_vh_"
	puts $fp "`define axixl_v1_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/axixl_v1_0_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axixl_v1_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 axixl_v1_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top axixl_v1_0_tb [get_filesets sim_1]
